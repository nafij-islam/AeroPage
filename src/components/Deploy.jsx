  ...
  return (
    <section className="py-[50px]">
      <Container>
        <Row >
          <Col lg={4} md={6} sm={12}>
            <div className="flex card-main items-center mb-[20px] gap-[50px] hover:shadow-md hover:shadow-red-300 duration-300 bg-[#fad0bc8f] pt-[30px] pb-[20px] pr-[40px] pl-[25px] rounded-[15px]">
              ...
              <div>
                ...
                <p className="w-[200px] diploy-pera" >
